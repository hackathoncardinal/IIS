Public Class DeliverySubForm
    ...
    Private Sub DeliverySubForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'InfotectDBMS1DataSet1.ClientForm' table. You can move, or remove it, as needed.
        Me.ClientFormTableAdapter.Fill(Me.InfotectDBMS1DataSet1.ClientForm)
